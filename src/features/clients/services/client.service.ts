    ...
    return {
      ...
      data: {
        clients: result.clients.map(client => ({
          ...
          userCount: (client as any)._count?.user || 0,
          locationCount: (client as any)._count?.client_location || 0,
  ...
  try {
    ...
    return {
      ...
      data: {
        ...
        userCount: (client as any)._count?.user || 0,
        locationCount: (client as any)._count?.client_location || 0,
        locations: ((client as any).client_location || []) as any[],
        contacts: ((client as any).contact || []) as any[],
        createdAt: client.crDate.toISOString(),
  ...
  try {
    ...
    return {
      ...
      data: {
        ...
        userCount: (updatedClient as any)._count?.user || 0,
        locationCount: (updatedClient as any)._count?.client_location || 0,
        locations: [],
        contacts: [],
